...
static const u8 *const sHoldEffectNames[HOLD_EFFECT_COUNT] =
{
    ...
    [HOLD_EFFECT_RED_SCARF]        = COMPOUND_STRING("Red Scarf"),
    [HOLD_EFFECT_BLUE_SCARF]       = COMPOUND_STRING("Blue Scarf"),
    [HOLD_EFFECT_PINK_SCARF]       = COMPOUND_STRING("Pink Scarf"),
    [HOLD_EFFECT_GREEN_SCARF]      = COMPOUND_STRING("Green Scarf"),
    [HOLD_EFFECT_YELLOW_SCARF]     = COMPOUND_STRING("Yellow Scarf"),
