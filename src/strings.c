...
const u8 *const gPocketNamesStringsTable[] =
{
    ...
    [POCKET_HELMS] =        COMPOUND_STRING("HELMS"),
    [POCKET_CLOAKS] =       COMPOUND_STRING("CLOAKS"),
    [POCKET_ARMOR] =        COMPOUND_STRING("ARMOR"),
    [POCKET_WEAPONS] =       COMPOUND_STRING("WEAPONS")
};
...
const u8 gText_Helms[] = _("HELMS");
const u8 gText_Cloaks[] = _("CLOAKS");
const u8 gText_Armor[] = _("ARMOR");
const u8 gText_Weapons[] = _("WEAPONS");
