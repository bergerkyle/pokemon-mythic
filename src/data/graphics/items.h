...
const u32 gItemIcon_MasterBlade[] = INCBIN_U32("graphics/items/icons/master_blade.4bpp.lz");
const u32 gItemIconPalette_MasterBlade[] = INCBIN_U32("graphics/items/icon_palettes/master_blade.gbapal.lz");