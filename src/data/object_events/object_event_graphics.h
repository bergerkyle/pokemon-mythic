...
const u16 gObjectEventPal_Torch[] = INCBIN_U16("graphics/object_events/palettes/fire.gbapal");
...
const u32 gObjectEventPic_Torch[] = INCBIN_U32("graphics/object_events/pics/misc/fire.4bpp");
