...
#define POCKET_HELMS       6
#define POCKET_CLOAKS      7
#define POCKET_ARMOR       8
#define POCKET_WEAPONS     9
...
#define HELMS_POCKET       5
#define CLOAKS_POCKET      6
#define ARMOR_POCKET       7
#define WEAPONS_POCKET     8
